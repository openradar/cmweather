...
latex_documents = [
  ('index', 'cmweather.tex', u'cmweather Documentation',
   u'Open Radar Community', 'manual'),
]
...
man_pages = [
    ('index', 'cmweather', u'cmweather Documentation',
     [author], 1)
]
...
texinfo_documents = [
  ('index', 'cmweather', u'cmweather Documentation',
   author, 'cmweather', 'One line description of project.',
   'Miscellaneous'),
]
